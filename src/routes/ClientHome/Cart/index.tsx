  ...
  return (
    <main>
      <section id="cart-container-section" className="dsc-container">
        {cart.items.length === 0 ? (
          <div>
            <h2 className="dsc-section-title dsc-mb20">Seu carrinho vazio</h2>
          </div>
        ) : (
          <div className="dsc-card dsc-mb20">
            {cart.items.map((x) => (
              ...
              >
                <div className="dsc-cart-item-left">
                  ...
                  <div className="dsc-cart-item-description">
                    ...
                    <div className="dsc-cart-item-quantity-container">
                      <div onClick={() => handleDecreaseItem(x.productId)} className="dsc-cart-item-quantity-btn">-</div>
                      <p>{x.quantity}</p>
                      <div
                        onClick={() => handleIncreaseItem(x.productId)}
                ...
                <div className="dsc-cart-item-right">
                  R${" "}
                  {typeof x.subTotal === "number" ? x.subTotal.toFixed(2) : ""}
                </div>
              </div>
            ))}
            ...
            <div className="dsc-cart-total-container">
              <h3>
                R$ {typeof cart.total === "number" ? cart.total.toFixed(2) : ""}
              </h3>
            </div>
          </div>
        )}
